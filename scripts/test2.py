...
if __name__ == "__main__":
    ...
    save_npz('data/input/matrices/JRUI03.I.npz', B)
    seq_ = find_lower_diagonal_path(B,reads_map,cols,rows)
    seq_record = SeqRecord(Seq(seq_), id="JRUI03", description="Genome reconstruction attempt")
    SeqIO.write(seq_record, "data/output/sequences/JRUI03.fasta", "fasta")
    save_npz('data/output/matrices/JRUI03.O.npz', B)
